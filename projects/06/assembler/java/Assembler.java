...
public class Assembler {
    ...
    static {
        ...
        cMap.put("R14", 14);
        cMap.put("R15", 15);
        cMap.put("SCREEN", 16384);
        cMap.put("KBD", 24576);

        // for c instructions comp=dst;jmp
        // put all comp posibilities with A into a HashMap,a=0
        compAMap.put("0", "101010");
        compAMap.put("1", "111111");
        compAMap.put("-1", "111010");
        compAMap.put("D", "001100");
        compAMap.put("A", "110000");
        compAMap.put("!D", "001101");
        compAMap.put("!A", "110001");
        compAMap.put("-D", "001111");
        compAMap.put("-A", "110011");
        compAMap.put("D+1", "011111");
        compAMap.put("A+1", "110111");
        compAMap.put("D-1", "001110");
        compAMap.put("A-1", "110010");
        compAMap.put("D+A", "000010");
        compAMap.put("D-A", "010011");
        compAMap.put("A-D", "000111");
        compAMap.put("D&A", "000000");
        compAMap.put("D|A", "010101");

        // put all comp posibilities with M into a HashMap,a=1
        compMMap.put("M", "110000");
        compMMap.put("!M", "110001");
        compMMap.put("-M", "110011");
        compMMap.put("M+1", "110111");
        compMMap.put("M-1", "110010");
        compMMap.put("D+M", "000010");
        compMMap.put("D-M", "010011");
        compMMap.put("M-D", "000111");
        compMMap.put("D&M", "000000");
    ...
    public static HashMap<String, Integer> findLabels(String codes) {
        ...
        String line = "";
        int pc = 0;
        Pattern p = Pattern.compile("^\\([^0-9][0-9A-Za-z\\_\\:\\.\\$]+\\)$");// start with ( and end with ) and consist
                                                                              // of uppercase
        Matcher m = null;
    ...
    public static String asmToHack(String codes) {
        ...
        while (scan.hasNextLine()) {
            ...
            if (line.charAt(0) == '@') {
                                ...
                                if (symbols.containsKey(varName)) {
                                    ...
                                    if (addressDec >= 16384) {
                                        ...
                                        throw new IllegalStateException(
                                                "Out of memory!Too many user defined symbols! Line " + lineNumber);
                ...
                if (dstMap.containsKey(dst) && (compMMap.containsKey(comp) || compAMap.containsKey(comp))
                        && jmpMap.containsKey(jmp)) {
